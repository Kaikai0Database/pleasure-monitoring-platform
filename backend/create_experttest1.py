"""
創建測試專家帳號 experttest1@gmail.com
角色: super_admin
密碼: test123
全域最高權限，可查看所有患者
"""
...
def create_experttest1():
    app = create_app()
    with app.app_context():
        # 檢查是否已存在
        existing = HealthcareStaff.query.filter_by(email='experttest1@gmail.com').first()
        
        if existing:
            print(f"\n⚠️  帳號 experttest1@gmail.com 已存在")
