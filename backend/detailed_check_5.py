...
with app.app_context():
    ...
    for email in target_emails:
        ...
        print(f"MA: 7d={ma_7:.2f if ma_7 else 'N/A'}, 14d={ma_14:.2f if ma_14 else 'N/A'}, 30d={ma_30:.2f if ma_30 else 'N/A'}")
        print(f"Daily Avg: {daily_avg:.2f if daily_avg else 'N/A'}")
            ...
            for ma, name in [(ma_7, '7d'), (ma_14, '14d'), (ma_30, '30d')]:
                if ma:
                    ...
                    if daily_avg > ma:
                        ...
                        print(f"  {name}: ⚠️ LOW (diff={diff:.2f})")
                    else:
