                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between mb-4">
                        <button
                            ...
                            className="px-4 py-2 bg-gray-300 border-4 border-gray-500 rounded-lg font-bold hover:bg-gray-400"
                        >
                            ← 上個月
                        </button>
                    ...
                    <p className="text-lg opacity-80 text-center">點擊日期記錄今天的心情</p>
                </div>
